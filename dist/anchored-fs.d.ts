...
export type AnchoredFsTestEvent = 'config-before-parent-check' | 'config-before-target-move' | 'config-before-final-verify' | 'snapshot-before-read' | 'snapshot-after-read' | 'artifact-before-read' | 'artifact-before-component-open' | 'artifact-before-final-verify' | 'database-before-constructor' | 'database-before-migration';
